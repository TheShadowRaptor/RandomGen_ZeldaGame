...
public class KillableComponent : ObjectComponent
{
    ...
    //        int damageAmount = eventSent.eventParameters.GetInt(Event, 0);
    ...
    //        if (damageAmount > 0) {
    //            health -= damageAmount;
    //            EventController tookDamageEvent = new EventController("TookDamage", eventSent);
    ...
    //                //DIED!
    //                Debug.Log("DED!");
    //                EventController dedEvent = new EventController("Died", eventSent);
